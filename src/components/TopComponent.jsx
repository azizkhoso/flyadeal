...
export default function TopComponent() {
  return (
    ...
    >
      <img src={logo} alt="logo" className="relative w-20 md:w-24 top-4 right-5" style={{ left: 'calc(100vw - 106px)' }} />
      <div className="w-full mx-auto md:w-11/12 xl:8/12" style={{ marginTop: '5%' }}>
        ...
        <div className="flex flex-col w-7/12 gap-2 mt-3 md:gap-4 h-3/4">
          ...
          <span className="mt-3 text-white text-mini md:mt-8 sm:text-sm md:text-lg">
